...
Добро пожаловать на неофициальный сайт 11-Ф класса <a href="http://rl.odessa.ua">Ришельевского лицея</a>! Мы очень рады вас видеть.<br />
...
echo ("<h3><a href='/physrl/dynamic/?p=allnews#n".$i."'>".$echofile[0]."</a></h3>");
